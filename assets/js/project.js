                    ...
                    markup: '<div class="project-preview mfp-with-anim">' +
                                ...
                                '<div class="mfp-projectDetail">' +
                                    '<div class="mfp-projectTrigger">' +
                                        ...
                                        '<div class="mfp-projectTitleWrap">' +
                                            '<div class="display-table-cell vertical-align-middle">' +
                                                '<span class="display-block font-family-alt letter-spacing-1 text-small text-uppercase">Position</span>' +
                                    ...
                                    '<div class="mfp-triggerClose text-center">' +
                                        '<span class="font-family-alt letter-spacing-2 text-uppercase text-extra-large text-white">Close Job Description</span>' +
                                    '</div>' +
                                '</div>' +
                            '</div>'
                },
